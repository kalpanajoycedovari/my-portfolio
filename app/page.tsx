...
const FEATURED = [
  ...
  { title: "UK Job Market Dashboard", tagline: "1.6M job postings. One dashboard.", desc: "Interactive Tableau dashboard analysing hiring companies, work types, and experience levels.", tags: ["Tableau", "SQL", "Data Analytics"], id: "uk-job-market", gradient: "linear-gradient(135deg,#0f1a2e,#1a2d4a,#0a1628)", accent: "#818cf8" },
];
